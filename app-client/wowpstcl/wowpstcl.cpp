...
// wowpstcl.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CwowpstclApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CwowpstclApp

CwowpstclApp::CwowpstclApp()
{
...
// Единственный объект CwowpstclApp

CwowpstclApp theApp;


// Инициализация CwowpstclApp

BOOL CwowpstclApp::InitInstance()
{
